...
def build_delaunay_net(sid: SimInputData, inc: Incidence) \
    ...
    pos_border_y = (pos[sid.n // 2][1] + pos[sid.n // 2 - 1][1]) / 2
    pos_border_x = sid.n / 5
    print(pos_border_x, pos_border_y)
    ...
    for tri in range(del_tri.nsimplex):
        ...
        if pos[n1][0] < pos_border_x and pos[n2][0] < pos_border_x and pos[n3][0] < pos_border_x:
            if (pos[n1][1] < pos_border_y and (pos[n2][1] > pos_border_y or pos[n3][1] > pos_border_y)) or (pos[n2][1] < pos_border_y and (pos[n1][1] > pos_border_y or pos[n3][1] > pos_border_y)) or (pos[n3][1] < pos_border_y and (pos[n2][1] > pos_border_y or pos[n1][1] > pos_border_y)):
                print(f"nodes {n1}, {n2}, {n3} disconnected")
                continue
